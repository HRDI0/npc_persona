...
| 발표 시각화와 deck | [presentation_visualization.md](presentation_visualization.md), [presentation/index.html](presentation/index.html) | 발표용 그림, 흐름 설명, HTML deck 근거를 맞출 때 |
